      ...
      <div className="w-full pt-2 lg:desktop-container tablet-container">
        ...
        <div className="flex items-center justify-between gap-3 px-4 md:px-0">
          <a href="#top" className="flex items-center gap-2 md:gap-3">
            ...
            <div>
              <span className="block font-display text-[15px] md:text-lg font-semibold tracking-tight text-[#3F2A22]">
                Crochet Craft
              </span>
              <span className="block text-[10px] md:text-[12px] font-medium text-[#3F2A22]/60">
                by Prakrati Ruhela
              </span>
            </div>
          </a>
          ...
          <div className="flex items-center gap-2 md:gap-3">
            <a 
              ...
              className="flex h-8 w-8 md:h-10 md:w-10 items-center justify-center rounded-full transition-all hover:scale-105 active:scale-95"
              style={{
            ...
            <a 
              ...
              target="_blank" 
              rel="noreferrer" 
              className="flex h-8 md:h-10 items-center gap-1.5 md:gap-2 rounded-full px-3 md:px-5 transition-all hover:brightness-105 active:scale-95"
              style={{
            ...
            >
              ...
              <span className="text-[11px] md:text-[14px] font-bold text-white hidden md:block">Order on WhatsApp</span>
            </a>
          </div>
        </div>
        ...
        <div className="mt-3 flex justify-center px-4 md:px-0">
          <div className="relative w-full md:w-[620px] tablet-container md:tablet-auto">
            ...
            <input
              ...
              className="h-[50px] md:h-[54px] w-full rounded-full border border-black/5 bg-[#FFFDF9] pr-4 pl-10 md:pr-6 md:pl-13 text-[14px] md:text-base shadow-sm outline-none transition-all placeholder:text-[#3F2A22]/40 focus:border-terracotta/40"
            />
          </div>
        </div>
            ...
            {mainCategories.map((c) => {
              ...
              return (
                <button
                  ...
                  className={`flex h-[48px] md:h-[54px] shrink-0 items-center rounded-full border px-3 md:px-4 transition-all active:scale-95 ${
                    active
                ...
                >
                  {c.icon && (
                    <span className="flex h-7 w-7 md:h-9 md:w-9 shrink-0 items-center justify-center text-[16px] md:text-[20px]">
                      {c.icon}
                    </span>
                  )}
                  <span className="ml-2 md:ml-3 whitespace-nowrap text-[13px] md:text-[14px] font-semibold">
                    {c.label}
                  </span>
                  <span className={`ml-2 pl-2 border-l border-current/20 text-[11px] md:text-[12px] font-bold opacity-60`}>
                    {count}
                  </span>
                </button>
              );
