        ...
        <div className="flex flex-col items-center justify-between gap-3 md:flex-row">
          ...
          <div className="flex items-center gap-3 bg-transparent border-none p-0 m-0 shadow-none outline-none ring-0">
            ...
            <a 
              ...
              target="_blank" 
              rel="noreferrer" 
              className="group flex h-12 items-center gap-2.5 overflow-hidden rounded-full border-none px-6 outline-none ring-0 transition-all hover:brightness-105 active:scale-95"
              style={{
            ...
            >
              <svg viewBox="0 0 24 24" fill="white" className="h-[22px] w-[22px]" aria-hidden="true">
